...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    ArrayList<Pokemon> the_list = new ArrayList<Pokemon>();
    ...
    public GreenAdapter(int numberOfItems, ListItemClickListener listener, ArrayList<Pokemon> list) {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        //viewHolder.viewHolderIndex.setText("ViewHolder index: " + the_list.get(viewHolderCount));
        viewHolder.viewHolderIndex.setText("ViewHolder index: " );
